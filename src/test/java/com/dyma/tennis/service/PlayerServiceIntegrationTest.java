...
public class PlayerServiceIntegrationTest {
    ...
    public void shouldFailToDelete_WhenPlayerDoesNotExist() {
        // Given
        String unknownPlayer = "DoeTest";

        // When / Then
        Exception exception = org.junit.jupiter.api.Assertions.assertThrows(PlayerNotFoundException.class, () -> {
            playerService.delete(unknownPlayer);
        });
        Assertions.assertThat(exception.getMessage()).isEqualTo("Player with last name " + unknownPlayer + " not found");
    }
}
